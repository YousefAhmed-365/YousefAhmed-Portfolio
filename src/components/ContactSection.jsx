...
export default function ContactSection() {
    ...
    return (
        <section id='contact-section' className='d-flex flex-column justify-content-center align-items-center'>
            <h1>Contact</h1>
            <hr />
            <div id='sp-contacts-group' ref={ani_0} className='mb-5 d-flex flex-wrap gap-3 w-100 justify-content-center' style={{ opacity: "0", bottom: "-55px" }}>
                ...
                <>
                    <Form onSubmit={handleSubmit} className='position-relative'>
                        ...
                        <div className='mt-3 d-flex justify-content-end'>
                            <button disabled={state.submitting} type="submit" className='sp-button py-3' onMouseOver={animate_hoverEffectEnter} onMouseOut={animate_hoverEffectLeave} onTouchStart={animate_hoverEffectEnter} onTouchEnd={animate_hoverEffectLeave}>
                                Send
                            </button>
                        </div>
